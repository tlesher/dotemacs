(custom-set-variables
 ...
 '(package-selected-packages
   '(magit python-mode fill-column-indicator deft buffer-move highlight-symbol hide-lines fuzzy flymake-cursor diminish which-key use-package-ensure-system-package use-package-el-get quickrun bash-completion helm helm-ebdb racer cargo rust-mode company 0blayout ivy counsel swiper zenburn-theme material-theme iodine-theme flycheck elpy color-theme-approximate)))
